...
import 'main/script/firebase_options.dart'; // generated by CI script
...
void main() {
  runZonedGuarded(() async {
    ...
    // Catches any uncaught exception (e.g. PlatformException from firebase_core
    // optionsFromResource) that escapes the try-catch above, so the app always
    // renders something instead of a white screen.
    runApp(App(initError: 'Fatal: $error'));
  });
}
...
/// 🔥 Firestore demo (writes to 'demo_messages')
